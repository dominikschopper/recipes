...
description: "Swedish cinnamon buns from a Swedish grandmother's recipe - authentic and delicious"
tags:
  - gebäck
  - hefe
  - zimt
  ...
  - frühstück
hasImages: true
portions: "ca. 25 Stück (reduzierte Menge)"
difficulty: "mittel"
time: "120 Minuten (inkl. Gehzeit)"
lastUpdated: true
---
...
1. Mehl auf den Teig stäuben, mit einem Tuch bedecken und ihn auf die doppelte Größe aufgehen lassen<br/>
   ![Hefeteig vor dem Gehen](./teig.png)
...
1. Wenn 1,8kg Mehl verwendet wurden, den Teig halbieren oder dritteln und jeden Teil in ein Rechteck ausrollen
  ![Teig ausgewellt](./teig_ausgewellt.png)
1. Füllung auf den ausgerollten Teig auftragen und der länge nach aufrollen<br/>
  ![Zimt-Buttermischung auf Teig 1](./teig_zimtbutter.png)<br/>
  ![Zimt-Buttermischung auf Teig 2](./teig_zimtbutter_02.png)
